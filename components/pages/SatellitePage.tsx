    ...
    <div className="flex items-center justify-center py-16">
      <Card className="max-w-3xl mx-auto text-center">
        <div className="p-6 md:p-10">
          <SatelliteIcon className="mx-auto h-16 w-16 text-primary-500" />
          ...
          <p className="mt-6 max-w-xl mx-auto text-lg text-gray-600 dark:text-gray-400">
            We are working hard to bring you this powerful new feature. Soon, you'll be able to monitor crop health, detect stress, and track growth patterns across your entire farm using advanced satellite data. Stay tuned!
          </p>
          <div className="mt-8 h-2 w-24 bg-gray-200 dark:bg-gray-700 rounded-full mx-auto animate-pulse"></div>
        </div>
      </Card>
    </div>
  );
