...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; description: string }> = ({ icon, title, description }) => (
  <Card className="text-center h-full">
    <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-primary-100 dark:bg-primary-900/40 mb-4">
        {icon}
    </div>
  ...
  const features = [
    {
      ...
      description: 'Get AI-powered predictions for crop yield and personalized recommendations.'
    },
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary-600 dark:text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>,
      title: 'AI Chatbot',
      description: 'Your 24/7 farming assistant for all queries on crops, schemes, and more.'
    },
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary-600 dark:text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>,
      title: 'Crop Disease Detection',
      description: 'Upload a photo of a leaf to instantly identify diseases and get solutions.'
    },
    {
      ...
      description: 'Accurate, location-based weather predictions to plan your farming activities.'
    }
  ];
    ...
    <div className="space-y-16 md:space-y-24">
      ...
      <section className="text-center pt-16 pb-12">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white">
          AI-driven Crop Yield Prediction & Optimization for <span className="text-primary-600 dark:text-primary-400">Indian Farmers</span>
        </h1>
        <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-gray-600 dark:text-gray-400">
          Empowering agriculture with data-driven insights for higher yields, better soil health, and sustainable farming practices.
        </p>
      ...
      <section>
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Why CropGuru?</h2>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">A complete solution for modern farming challenges.</p>
        </div>
      ...
      {/* Impact Section */}
      <section className="bg-primary-50 dark:bg-gray-800/50 rounded-2xl p-8 md:p-12">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <span className="block text-4xl md:text-5xl font-bold text-primary-600 dark:text-primary-400">30%</span>
              <span className="mt-2 block text-lg font-medium text-gray-700 dark:text-gray-300">Higher Yield Potential</span>
            </div>
            <div>
              <span className="block text-4xl md:text-5xl font-bold text-primary-600 dark:text-primary-400">40%</span>
              <span className="mt-2 block text-lg font-medium text-gray-700 dark:text-gray-300">Reduced Water Usage</span>
            </div>
            <div>
              <span className="block text-4xl md:text-5xl font-bold text-primary-600 dark:text-primary-400">70%</span>
              <span className="mt-2 block text-lg font-medium text-gray-700 dark:text-gray-300">Less Scouting Time</span>
            </div>
          </div>
        </div>
      </section>
